...
<body>
    <video autoplay muted loop id="bg-video">
        ...
        <!-- <source src="images/mylivewallpapers-com-Black-Skull-4K.mp4" type="video/mp4"> -->

    </video>
    <div id="page1">
        <nav>
            <h1  id="logo">BLAUNX</h1>
        </nav>

        <div id="page1-container">
            <div id="left-box">
                <div id="potrait-container">
                    <img src="images/daredevil-born-3840x2160-25420.jpg" alt="">
                </div>                
            ...
            <div id="right-box">
                ...
                <!-- <p>Lorem ipsum dolor sit amet consectetur 
                    adipisicing elit. Aperiam quaerat nisi ducimus
                    adipisci dolores perspiciatis doloremque 
                    laudantium fugit voluptas recusandae!
